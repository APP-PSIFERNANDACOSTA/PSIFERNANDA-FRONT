      ...
      <div className="flex w-full min-w-0 flex-col gap-6">
        <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-semibold tracking-tight">Nova anotação</h1>
              <p className="text-sm text-muted-foreground mt-1">
                Texto livre ou modelo pós-terapia. Opcionalmente vincule a uma sessão.
              </p>
            </div>
          </div>
        </div>

        <PatientNoteForm patientId={patientId} patientName={patient?.name} />
      </div>
    </DashboardLayout>
  )
}
