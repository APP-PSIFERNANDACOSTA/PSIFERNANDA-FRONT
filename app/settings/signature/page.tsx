    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500">Gerencie sua assinatura digital para os contratos</p>
        </div>
            ...
            <CardContent className="space-y-4">
              {hasSignature && signatureUrl ? (
                ...
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p className="text-sm">Faça upload de uma imagem para visualizar aqui</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <CardContent className="space-y-3">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">
                  Sua assinatura será aplicada automaticamente nos PDFs dos contratos
                </p>
              </div>
              ...
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                ...
                <p className="text-sm text-gray-600">
                  Os contratos assinados terão validade legal com sua assinatura digital
                </p>
              </div>
            </div>
          </CardContent>
